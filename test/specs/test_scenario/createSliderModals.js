...
describe('TrueAutomation.IO page WebdirverIO + TrueAutomation', () => {
  it('Test example', () => {
    ...
    $(ta(   'exp:rockdaisy:picker:sliderName')).setValue('newSlideName1');
    browser.pause(1000)//for clarity
    ...
    $(ta(   'exp:rockdaisy:picker:sliderName')).setValue('newSlideName2');
    browser.pause(1000)//for clarity
    ...
    //click to set new name
    $(ta(   'exp:rockdaisy:picker:sliderName')).setValue('newSlideName3');
    browser.pause(1000)//for clarity
